...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:border-white/20 hover:scale-[1.02] duration-200 transition shadow-[inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.2)]",
        primary: "bg-[rgba(var(--primary),0.1)] border border-[rgba(var(--primary),0.3)] text-white hover:bg-[rgba(var(--primary),0.2)] hover:border-[rgba(var(--primary),0.5)] hover:scale-[1.02] duration-200 transition shadow-[inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.2)]",
        destructive: "bg-red-500/10 border border-red-500/30 text-red-400 hover:bg-red-500/20 hover:border-red-500/50 hover:scale-[1.02] duration-200 transition shadow-[inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.2)]",
        outline: "border border-input bg-transparent hover:bg-accent hover:text-accent-foreground hover:scale-[1.02] duration-200 transition",
        secondary: "bg-[rgba(var(--secondary),0.1)] border border-[rgba(var(--secondary),0.3)] text-white hover:bg-[rgba(var(--secondary),0.2)] hover:border-[rgba(var(--secondary),0.5)] hover:scale-[1.02] duration-200 transition shadow-[inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.2)]",
        gold: "bg-amber-500/10 border border-amber-500/30 text-amber-400 hover:bg-amber-500/20 hover:border-amber-500/50 hover:scale-[1.02] duration-200 transition shadow-[inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.2)]",
        success: "bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/20 hover:border-emerald-500/50 hover:scale-[1.02] duration-200 transition shadow-[inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.2)]",
        ghost: "hover:bg-accent hover:text-accent-foreground hover:scale-[1.02] duration-200 transition",
        link: "text-primary underline-offset-4 hover:underline",
      },
      size: {
...
export const MetalButton = React.forwardRef<
  HTMLButtonElement,
  MetalButtonProps & { wrapperClassName?: string }
>(({ children, className, variant = "default", wrapperClassName, ...props }, ref) => {
